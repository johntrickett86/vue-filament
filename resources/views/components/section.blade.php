...
<section
    ...
    {{
        $attributes->class([
            'fi-section max-w-2xl md:block lg:w-48',
            match ($aside) {
                true => 'fi-aside grid grid-cols-1 items-start gap-x-6 gap-y-4 md:grid-cols-3',
                false => 'rounded-xl bg-gray-50 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10',
            },
        ])
    }}
>
    ...
    <div
        ...
        @class([
            ...
            'border-none border-gray-200 dark:border-white/10' => $hasHeader && (! $aside),
